<?php
		...
		$to      = $values['contact-form-mail'];
		$subject = 'Thanks for contacting AirDroids makers of The Pocket Drone';
		$message = 'We are currently getting a lot of mail. We are working hard to get back to everyone as quickly as possible. \n\n Thanks for your inquiry \n Team AirDroids';
		// $headers = 'From: support@airdroids.com' . "\r\n" .  'Reply-To:support@airdroids.com' . "\r\n" .  'X-Mailer: PHP/' . phpversion();

		$headers  = 'MIME-Version: 1.0' . "\r\n";
		$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";

		// Additional headers
		//$headers .= 'To: y <mary@example.com>, Kelly <kelly@example.com>' . "\r\n";
