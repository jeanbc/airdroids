<?php
		define('CONTACT_FORM_TO_NAME','AirDroids Support');
		// define('CONTACT_FORM_TO_EMAIL','croth@airdroids.com,treuter@airdroids.com,tj@airdroids.com');
		define('CONTACT_FORM_TO_EMAIL','team@airdroids.com');
		...
		define('CONTACT_FORM_SUBJECT','AirDroids Landing Page: Contact from WWW');
